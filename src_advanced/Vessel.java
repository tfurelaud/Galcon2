...
public class Vessel {
	 ...
	 * Ready : true if all the settings are affiliate to the vessel before he takes off. 
	 * Strong : true if the vessel is a strong vessel. 
	 * Pirate: true if the vessel is a pirate.
	 * */
	private boolean movement = false, waiting = false, strong = false;
	...
	/**
	 * Sets strong to true if the vessel is strong.
	 *
	 * @param strong the new value.
	 */
	...
	public void draw(GraphicsContext gc) {
		if(strong == true) {
			...
			gc.strokeRect(x-2, y-2, width+2, height +2 );
		}
		gc.setStroke(Color.BLACK);
